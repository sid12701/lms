...
import { axeBaseElement } from "@/test/utils";
...
describe("TopBar", () => {
  ...
  it("has no axe violations with the user menu open (portalled content lives on baseElement)", async () => {
    const user = userEvent.setup();
    const { getByLabelText, findByRole, baseElement } = renderTopBar();
    await user.click(getByLabelText(`Account menu for ${adminSession.user.username}`));
