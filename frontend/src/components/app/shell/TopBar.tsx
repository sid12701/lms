 ...
 * notifications + help icons, the user menu, and the theme toggle. The actual
 * command palette dialog is mounted here so its global shortcut is always live; the trigger button dispatches the same shortcut so
