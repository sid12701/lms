...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        // eslint-disable-next-line react/prop-types -- shadcn DayPicker render-prop components
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return <IconChevronLeft className={cn("cn-rtl-flip size-4", className)} {...props} />;
          }

          if (orientation === "right") {
            return <IconChevronRight className={cn("cn-rtl-flip size-4", className)} {...props} />;
          }
