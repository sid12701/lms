...
export function ProductsPage() {
  ...
  return (
    <AdminEntityListPage
      ...
      filterBar={<ProductsFilterBar filters={filters} onChange={setFilters} />}
      table={
        <ProductsTable
          data={list.data}
      ...
      dialogs={
        <>
          ...
          <ProductMappingDialog
            ...
            errorMessage={
              updateMapping.isError ? extractAdminErrorMessage(updateMapping.error) : null
            }
          />
        </>
      }
