...
import type { ProductMutationResponse, UpdateProductMappingInput } from "../types";
import { PRODUCTS_LIST_QUERY_KEY } from "./useProducts";
import { PRODUCT_DETAIL_QUERY_KEY } from "./useProduct";

export interface UpdateProductMappingVariables extends UpdateProductMappingInput {
  id: string;
}
...
> {
  ...
  return useMutation<ProductMutationResponse, Error, UpdateProductMappingVariables>({
