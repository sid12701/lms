 ...
 * (not under `src/mocks/`) because they are a presentational test seam:
 * the real mock-API fixtures live in `src/mocks/api/audit.ts` (Phase 8).
 *
 * These fixtures intentionally use stable, pre-canned UUIDs and ISO
