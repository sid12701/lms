 ...
 * them.
 *
 * The product schema mirrors `LoanProduct`'s superRefine (principalMin ≤
 * principalMax, tenureMinMonths ≤ tenureMaxMonths) so RHF can surface the
 * exact same validation error as the mock router.
 */
import { z } from "zod";
