...
@Entity
@Table(name = "loan_application_audit_event")
public class LoanApplicationAuditEvent {
    ...
    private LoanApplicationAuditAction action;

    @Column(name = "actor_username", nullable = false, length = 255)
    private String actorUsername;

    @Enumerated(EnumType.STRING)
    @Column(name = "from_status", nullable = false, length = 64)
    ...
    protected LoanApplicationAuditEvent() {
    }

    public LoanApplicationAuditEvent(
    ...
    public LoanApplicationAuditAction getAction() {
        return action;
    }
