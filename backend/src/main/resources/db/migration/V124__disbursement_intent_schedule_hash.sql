-- H15: freeze the canonical repayment-schedule hash on the disbursement intent.
--
...
-- existing C02/H02 paths. Nullable with no backfill, no default, and no RLS change
...
COMMENT ON COLUMN disbursement_intent.schedule_hash IS
    'H15: canonical SHA-256 hash of the persisted repayment schedule frozen at intent creation; NULL for pre-H15 rows.';
