...
class LoanApplicationReadRepositoryTest {
    ...
    void filtersApplicationsByStructuredParametersAndSearchQuery() {
        ...
        LoanApplication matchingApplication = loanApplicationRepository.save(application(
                borrower(north, "Rahul Shah", "ZXCVB1234N", "9876543210", "rahul@example.com", "Delhi", "Delhi", "SELF_EMPLOYED"),
                north,
                merchantProduct,
                "NORTH-200",
                "PARTNER_PORTAL",
        ...
        loanApplicationRepository.save(application(
                borrower(north, "Rahul Mehta", "QWERT1234P", "9811111111", "rahul.mehta@example.com", "Delhi", "Delhi", "SELF_EMPLOYED"),
                north,
                merchantProduct,
                "NORTH-201",
                "API",
    ...
    void filtersApplicationsByDisbursalDateRange() {
        ...
        LoanApplication aprilApplication = loanApplicationRepository.save(application(
                borrower(lsp, "Bhavna Rao", "ABCDE1002F", "9000001002", "bhavna@example.com", "Pune", "Maharashtra", "SALARIED"),
                lsp,
                product,
                "SUPA-1002",
                "API",
