...
class AlertRuleSchedulerWorkerTenantContextTest {
    ...
    @Test
    void scheduledEvaluationRestoresEmptyTenantContextOnWorkerThread() {
        TenantDataAccessContextHolder.clear();
        assertNull(TenantDataAccessContextHolder.snapshot());

        alertRuleSchedulerWorker.evaluateScheduledAlertRules();
