...
|---|---|---|
| **APPROVED — ready to build** | The owner has approved this solution. Implement as written. | 74 |
| **DEFERRED — do not start** | The owner has parked it. The spec is kept current so work can start the day it is un-parked. | 4 |
| **PROPOSED — not yet approved** | Solution drafted from the code, not signed off. Confirm before starting. | 0 |
...
## 2. Summary — 78 technical items

| ID | Title | Sev | WS | Status | Issue |
|---|---|---|---|---|---|
| **C13** | 88% of backend tests run on H2 with Flyway off — no fix below is verifiable until this changes | Critical | WS-9 | APPROVED | [#252](https://github.com/sid12701/lms/issues/252) |
| **C1** | Idempotent LSP writes run with row-level security fully off | Critical | WS-1 | APPROVED | [#253](https://github.com/sid12701/lms/issues/253) |
| **C2** | Any LSP can overwrite another LSP's borrower bank account, with no audit row | Critical | WS-1 | DEFERRED | [#254](https://github.com/sid12701/lms/issues/254) |
| **C3** | A deactivated user keeps full access forever by refreshing the token | Critical | WS-2 | APPROVED | [#255](https://github.com/sid12701/lms/issues/255) |
| **C4** | Disabling an LSP kills its API clients and leaves its human users signed in | Critical | WS-2 | APPROVED | [#256](https://github.com/sid12701/lms/issues/256) |
| **C6** | A borrower who never pays is never delinquent | Critical | WS-4 | APPROVED | [#257](https://github.com/sid12701/lms/issues/257) |
| **C7** | No payment reversal exists, and CLOSED cannot be reopened | Critical | WS-3 | DEFERRED | [#258](https://github.com/sid12701/lms/issues/258) |
| **C9** | Every operator retry mints a new Idempotency-Key, so retries double-pay | Critical | WS-8 | APPROVED | [#259](https://github.com/sid12701/lms/issues/259) |
| **C10** | The frontend silently converts a rejected transition into an admin override | Critical | WS-8 | APPROVED | [#260](https://github.com/sid12701/lms/issues/260) |
| **C11** | A deploy with no profile boots on the repo-committed JWT secret, with the validator off | Critical | WS-9 | APPROVED | [#261](https://github.com/sid12701/lms/issues/261) |
| **C12** | The 11 custom metrics have no registry and no endpoint | Critical | WS-9 | DEFERRED | [#262](https://github.com/sid12701/lms/issues/262) |
| **H1** | Two allocation authorities that will diverge | High | WS-3 | APPROVED | [#263](https://github.com/sid12701/lms/issues/263) |
| **H2** | Money rounds to 2 decimals at every intermediate step | High | WS-3 | APPROVED | [#264](https://github.com/sid12701/lms/issues/264) |
| **H7** | The non-intent disbursement path calls the bank inside the transaction | High | WS-5 | APPROVED | [#265](https://github.com/sid12701/lms/issues/265) |
| **H8** | Intents in REQUESTED or UNKNOWN can never be actioned | High | WS-5 | APPROVED | [#266](https://github.com/sid12701/lms/issues/266) |
| **H10** | Eligibility is evaluated against the mutable live product row | High | WS-3 | APPROVED | [#267](https://github.com/sid12701/lms/issues/267) |
| **H11** | The schedule is anchored on approval and never re-anchored at disbursement | High | WS-3 | APPROVED | [#268](https://github.com/sid12701/lms/issues/268) |
| **H12** | The business date is computed in UTC while the clock is IST | High | WS-3 | APPROVED | [#269](https://github.com/sid12701/lms/issues/269) |
| **H13** | No day-end process exists | High | WS-4 | APPROVED | [#270](https://github.com/sid12701/lms/issues/270) |
| **H14** | Buckets are generic 30-day bins with no SMA, NPA or provisioning | High | WS-4 | APPROVED | [#271](https://github.com/sid12701/lms/issues/271) |
| **H15** | Three DPD computations over three different populations | High | WS-4 | APPROVED | [#272](https://github.com/sid12701/lms/issues/272) |
| **H16** | MIS is as-of generation time, not as-of the period | High | WS-9 | APPROVED | [#273](https://github.com/sid12701/lms/issues/273) |
| **H17** | The MIS preview is an unaudited bulk PII export | High | WS-6 | APPROVED | [#274](https://github.com/sid12701/lms/issues/274) |
| **H18** | The report worker holds a whole batch in one transaction and can wedge permanently | High | WS-9 | APPROVED | [#275](https://github.com/sid12701/lms/issues/275) |
| **H19** | No tamper evidence of any kind | High | WS-6 | APPROVED | [#276](https://github.com/sid12701/lms/issues/276) |
| **H20** | ON DELETE CASCADE runs from business parents into audit tables | High | WS-6 | APPROVED | [#277](https://github.com/sid12701/lms/issues/277) |
| **H21** | The tenant database role holds UPDATE and DELETE on audit and financial evidence tables | High | WS-6 | APPROVED | [#278](https://github.com/sid12701/lms/issues/278) |
| **H22** | The audit explorer masks Aadhaar and nothing else | High | WS-6 | APPROVED | [#279](https://github.com/sid12701/lms/issues/279) |
| **H23** | The audit explorer covers 8 of 15 audit tables | High | WS-6 | APPROVED | [#280](https://github.com/sid12701/lms/issues/280) |
| **H24** | A product interest-rate change writes an audit row that does not contain the rate | High | WS-6 | APPROVED | [#281](https://github.com/sid12701/lms/issues/281) |
| **H25** | Document replacement orphans the previous evidence | High | WS-6 | APPROVED | [#282](https://github.com/sid12701/lms/issues/282) |
| **H26** | Zero storage deletes, no object lock, no versioning, no lifecycle | High | WS-6 | APPROVED | [#283](https://github.com/sid12701/lms/issues/283) |
| **H28** | The bootstrap admin is re-created and re-granted SYSTEM_ADMIN on every boot | High | WS-2 | APPROVED | [#284](https://github.com/sid12701/lms/issues/284) |
| **H29** | A password change does not revoke refresh tokens, and a comment claims it does | High | WS-2 | APPROVED | [#285](https://github.com/sid12701/lms/issues/285) |
| **H30** | Lockout is a 5-minute batch job, permanent until an admin resets it, and blind to distributed attacks | High | WS-2 | APPROVED | [#286](https://github.com/sid12701/lms/issues/286) |
| **H31** | Six tenant-attributable tables have no row-level security at all | High | WS-1 | APPROVED | [#287](https://github.com/sid12701/lms/issues/287) |
| **H32** | The tenant database role can read password_hash and secret_hash | High | WS-1 | APPROVED | [#288](https://github.com/sid12701/lms/issues/288) |
| **H33** | OPS_USER can create loan applications for any LSP with no tenant check | High | WS-1 | APPROVED | [#289](https://github.com/sid12701/lms/issues/289) |
| **H34** | LSP bank-detail writes and application creation run admin-scoped | High | WS-1 | APPROVED | [#290](https://github.com/sid12701/lms/issues/290) |
| **H35** | No rate limit on any LSP read endpoint | High | WS-7 | APPROVED | [#291](https://github.com/sid12701/lms/issues/291) |
| **H36** | X-Forwarded-For is trusted from the raw header | High | WS-7 | APPROVED | [#292](https://github.com/sid12701/lms/issues/292) |
| **H37** | One webhook signing secret per LSP, with no rotation grace | High | WS-7 | APPROVED | [#293](https://github.com/sid12701/lms/issues/293) |
| **H38** | Webhook ordering is not guaranteed for a single loan | High | WS-7 | APPROVED | [#294](https://github.com/sid12701/lms/issues/294) |
| **H39** | Payment idempotency keys are globally unique and guarded by a JVM-local lock | High | WS-7 | APPROVED | [#295](https://github.com/sid12701/lms/issues/295) |
| **H40** | The rate limiter fails hard-closed with an untyped 500 when Redis is unavailable | High | WS-7 | APPROVED | [#296](https://github.com/sid12701/lms/issues/296) |
| **H41** | Three fused error envelopes, one of them scraped from Mambu's documentation | High | WS-7 | APPROVED | [#297](https://github.com/sid12701/lms/issues/297) |
| **H42** | A 90-day plaintext PII dossier sits in the idempotency store | High | WS-7 | APPROVED | [#298](https://github.com/sid12701/lms/issues/298) |
| **H43** | No backup, restore or disaster recovery exists in the repository | High | WS-9 | APPROVED | [#299](https://github.com/sid12701/lms/issues/299) |
| **H44** | An OpsAlert never leaves the database | High | WS-9 | DEFERRED | [#300](https://github.com/sid12701/lms/issues/300) |
| **H45** | The correlation id is written to MDC and never rendered | High | WS-9 | APPROVED | [#301](https://github.com/sid12701/lms/issues/301) |
| **H46** | All 7 scheduled workers share one thread | High | WS-9 | APPROVED | [#302](https://github.com/sid12701/lms/issues/302) |
| **H47** | No deployment artifact, no prod profile, no graceful shutdown | High | WS-9 | APPROVED | [#303](https://github.com/sid12701/lms/issues/303) |
| **M1** | Money crosses the wire as a JSON number | Medium | WS-7 | APPROVED | [#304](https://github.com/sid12701/lms/issues/304) |
| **M2** | Row-level security policies are written in a shape that cannot be optimised | Medium | WS-1 | APPROVED | [#305](https://github.com/sid12701/lms/issues/305) |
| **M3** | autoCommit=false on the tenant pool combines badly with the Postgres outbox | Medium | WS-9 | APPROVED | [#306](https://github.com/sid12701/lms/issues/306) |
| **M4** | No CREATE INDEX CONCURRENTLY in 103 index creations | Medium | WS-9 | APPROVED | [#307](https://github.com/sid12701/lms/issues/307) |
| **M5** | Status columns are bare VARCHAR with no CHECK constraint | Medium | WS-9 | APPROVED | [#308](https://github.com/sid12701/lms/issues/308) |
| **M6** | Unmasked PAN inside ops_alert.message | Medium | WS-6 | APPROVED | [#309](https://github.com/sid12701/lms/issues/309) |
| **M7** | PAN is unmasked on every JSON surface and masked only in the CSV | Medium | WS-6 | APPROVED | [#310](https://github.com/sid12701/lms/issues/310) |
| **M8** | CSV formula injection | Medium | WS-9 | APPROVED | [#311](https://github.com/sid12701/lms/issues/311) |
| **M9** | The filesystem storage provider is reachable in production | Medium | WS-6 | APPROVED | [#312](https://github.com/sid12701/lms/issues/312) |
| **M10** | Idempotency-Key is required on 3 endpoints, optional on 4, and absent on 4 | Medium | WS-7 | APPROVED | [#313](https://github.com/sid12701/lms/issues/313) |
| **M11** | Offset pagination with an unbounded offset, and three endpoints with none | Medium | WS-7 | APPROVED | [#314](https://github.com/sid12701/lms/issues/314) |
| **M12** | Raw exception messages are returned to partners on 4xx | Medium | WS-7 | APPROVED | [#315](https://github.com/sid12701/lms/issues/315) |
| **M13** | The frontend has no field-level error mapping | Medium | WS-8 | APPROVED | [#316](https://github.com/sid12701/lms/issues/316) |
| **M14** | Five of six list screens fetch the whole table and paginate in JavaScript | Medium | WS-8 | APPROVED | [#317](https://github.com/sid12701/lms/issues/317) |
| **M15** | A failed read after a successful write reports the write as failed | Medium | WS-8 | APPROVED | [#318](https://github.com/sid12701/lms/issues/318) |
| **M16** | The repayment posted date is truncated in UTC | Medium | WS-8 | APPROVED | [#319](https://github.com/sid12701/lms/issues/319) |
| **M17** | Foreclosure execute is a bare button with no confirmation | Medium | WS-8 | APPROVED | [#320](https://github.com/sid12701/lms/issues/320) |
| **M18** | Roles are collapsed to one, with a fail-open default to OPS_USER | Medium | WS-8 | APPROVED | [#321](https://github.com/sid12701/lms/issues/321) |
| **L1** | app_permission and app_role_permission are dead schema | Low | WS-9 | APPROVED | [#322](https://github.com/sid12701/lms/issues/322) |
| **L2** | loan_application_pii_reveal_audit is migrated, protected, modelled and permanently empty | Low | WS-6 | APPROVED | [#323](https://github.com/sid12701/lms/issues/323) |
| **L3** | allInstallmentsSettled is vacuously true for an empty schedule | Low | WS-3 | APPROVED | [#324](https://github.com/sid12701/lms/issues/324) |
| **R3** | Bureau reporting — fortnightly, with a ₹100-a-day compensation meter | Regulatory | WS-10 | APPROVED | [#325](https://github.com/sid12701/lms/issues/325) |
| **R4** | Sanctions, PEP and STR screening — the obligation with immediate action | Regulatory | WS-10 | APPROVED | [#326](https://github.com/sid12701/lms/issues/326) |
| **R5** | Retention and erasure — neither capability exists | Regulatory | WS-10 | APPROVED | [#327](https://github.com/sid12701/lms/issues/327) |
| **N1** | A full 12 MB Formance Go repository sits inside the Java source tree, untracked | New | WS-9 | APPROVED | [#328](https://github.com/sid12701/lms/issues/328) |
| **N2** | The tenant connection strategy is selected by matching a hostname string, and Azure will not match it | High | WS-1 | APPROVED | [#329](https://github.com/sid12701/lms/issues/329) |
...
| **GitHub issue** | [#252](https://github.com/sid12701/lms/issues/252) |
...
| **GitHub issue** | [#253](https://github.com/sid12701/lms/issues/253) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#254](https://github.com/sid12701/lms/issues/254) |
...
| **GitHub issue** | [#255](https://github.com/sid12701/lms/issues/255) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#256](https://github.com/sid12701/lms/issues/256) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#257](https://github.com/sid12701/lms/issues/257) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#258](https://github.com/sid12701/lms/issues/258) |
| **Triage label** | `needs-triage` |
...
| **GitHub issue** | [#259](https://github.com/sid12701/lms/issues/259) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#260](https://github.com/sid12701/lms/issues/260) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#261](https://github.com/sid12701/lms/issues/261) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#262](https://github.com/sid12701/lms/issues/262) |
| **Triage label** | `needs-triage` |
...
| **GitHub issue** | [#263](https://github.com/sid12701/lms/issues/263) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#264](https://github.com/sid12701/lms/issues/264) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 1 day |
| **Dependencies** | None |
| **GitHub issue** | [#265](https://github.com/sid12701/lms/issues/265) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#266](https://github.com/sid12701/lms/issues/266) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 2 days |
| **Dependencies** | None |
| **GitHub issue** | [#267](https://github.com/sid12701/lms/issues/267) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#268](https://github.com/sid12701/lms/issues/268) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#269](https://github.com/sid12701/lms/issues/269) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#270](https://github.com/sid12701/lms/issues/270) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#271](https://github.com/sid12701/lms/issues/271) |
| **Triage label** | `ready-for-agent` |
...
| **Dependencies** | C6, H13 |
| **GitHub issue** | [#272](https://github.com/sid12701/lms/issues/272) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#273](https://github.com/sid12701/lms/issues/273) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#274](https://github.com/sid12701/lms/issues/274) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 1 week |
| **Dependencies** | None |
| **GitHub issue** | [#275](https://github.com/sid12701/lms/issues/275) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#276](https://github.com/sid12701/lms/issues/276) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#277](https://github.com/sid12701/lms/issues/277) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#278](https://github.com/sid12701/lms/issues/278) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#279](https://github.com/sid12701/lms/issues/279) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 3 days |
| **Dependencies** | None |
| **GitHub issue** | [#280](https://github.com/sid12701/lms/issues/280) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 2 days |
| **Dependencies** | None |
| **GitHub issue** | [#281](https://github.com/sid12701/lms/issues/281) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#282](https://github.com/sid12701/lms/issues/282) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#283](https://github.com/sid12701/lms/issues/283) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#284](https://github.com/sid12701/lms/issues/284) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | Half a day |
| **Dependencies** | C3 |
| **GitHub issue** | [#285](https://github.com/sid12701/lms/issues/285) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 1 week |
| **Dependencies** | None |
| **GitHub issue** | [#286](https://github.com/sid12701/lms/issues/286) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#287](https://github.com/sid12701/lms/issues/287) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#288](https://github.com/sid12701/lms/issues/288) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#289](https://github.com/sid12701/lms/issues/289) |
| **Triage label** | `ready-for-agent` |
...
| **Dependencies** | C1 |
| **GitHub issue** | [#290](https://github.com/sid12701/lms/issues/290) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#291](https://github.com/sid12701/lms/issues/291) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#292](https://github.com/sid12701/lms/issues/292) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#293](https://github.com/sid12701/lms/issues/293) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#294](https://github.com/sid12701/lms/issues/294) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#295](https://github.com/sid12701/lms/issues/295) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#296](https://github.com/sid12701/lms/issues/296) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#297](https://github.com/sid12701/lms/issues/297) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#298](https://github.com/sid12701/lms/issues/298) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#299](https://github.com/sid12701/lms/issues/299) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#300](https://github.com/sid12701/lms/issues/300) |
| **Triage label** | `needs-triage` |
...
| **GitHub issue** | [#301](https://github.com/sid12701/lms/issues/301) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#302](https://github.com/sid12701/lms/issues/302) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#303](https://github.com/sid12701/lms/issues/303) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#304](https://github.com/sid12701/lms/issues/304) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#305](https://github.com/sid12701/lms/issues/305) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#306](https://github.com/sid12701/lms/issues/306) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#307](https://github.com/sid12701/lms/issues/307) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 3 days |
| **Dependencies** | C13 |
| **GitHub issue** | [#308](https://github.com/sid12701/lms/issues/308) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#309](https://github.com/sid12701/lms/issues/309) |
| **Triage label** | `ready-for-agent` |
...
| **Dependencies** | H22 |
| **GitHub issue** | [#310](https://github.com/sid12701/lms/issues/310) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 1 day |
| **Dependencies** | None |
| **GitHub issue** | [#311](https://github.com/sid12701/lms/issues/311) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#312](https://github.com/sid12701/lms/issues/312) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#313](https://github.com/sid12701/lms/issues/313) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#314](https://github.com/sid12701/lms/issues/314) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 2 days |
| **Dependencies** | H41 |
| **GitHub issue** | [#315](https://github.com/sid12701/lms/issues/315) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 4 days |
| **Dependencies** | None |
| **GitHub issue** | [#316](https://github.com/sid12701/lms/issues/316) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#317](https://github.com/sid12701/lms/issues/317) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#318](https://github.com/sid12701/lms/issues/318) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#319](https://github.com/sid12701/lms/issues/319) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 3 days |
| **Dependencies** | Do it with C9 and C10. |
| **GitHub issue** | [#320](https://github.com/sid12701/lms/issues/320) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 4 days |
| **Dependencies** | None |
| **GitHub issue** | [#321](https://github.com/sid12701/lms/issues/321) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | Half a day |
| **Dependencies** | None |
| **GitHub issue** | [#322](https://github.com/sid12701/lms/issues/322) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 2 days |
| **Dependencies** | H23 |
| **GitHub issue** | [#323](https://github.com/sid12701/lms/issues/323) |
| **Triage label** | `ready-for-agent` |
...
| **Effort** | 1 hour |
| **Dependencies** | None |
| **GitHub issue** | [#324](https://github.com/sid12701/lms/issues/324) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#325](https://github.com/sid12701/lms/issues/325) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#326](https://github.com/sid12701/lms/issues/326) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#327](https://github.com/sid12701/lms/issues/327) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#328](https://github.com/sid12701/lms/issues/328) |
| **Triage label** | `ready-for-agent` |
...
| **GitHub issue** | [#329](https://github.com/sid12701/lms/issues/329) |
| **Triage label** | `ready-for-agent` |
...
### 4.1 Blocked — technical work waiting on a business answer (9)

Do not start these. Each needs one specific business decision first.

| ID | Title | Waiting on |
|---|---|---|
| C5 | Foreclosure charges every rupee of future contracted interest | Needs MR7, MR8 and MR9. You deferred it, which is consistent. |
| C8 | No penal charge, late fee, bounce charge or GST model | Needs MR5 and MR6. Nothing can be charged until the charges exist. |
| H3 | Only an exact installment amount can be posted | Needs MR1. You deferred it. |
| H4 | Foreclosure quotes never expire and the effective date is unvalidated | Needs MR7. Deferred with C5. |
| H5 | Foreclosure over-payment strands money on an immutable row | Needs MR2 — reject, hold as advance, or refund. |
| H6 | No disbursement cap and no velocity limit | The mechanism is ready. The cap and velocity numbers are a business input. |
| H9 | Interest is charged on gross while the disbursal is net, and APR is computed nowhere | Needs C8, so it needs MR5. An APR without a charge model is not an APR. |
| R1 | KFS and APR — the deadline passed on 1 October 2024 | Needs C8 and MR8. The KFS must disclose charges that do not yet exist. |
| R2 | CKYC — a 10-day clock is already running on every disbursed loan | Needs a build-or-buy call on the CKYC route: direct CERSAI SFTP, or an aggregator. |

### 4.2 Business track — parked by the owner (16)

- **H27** — No maker-checker anywhere
- **L4** — No currency dimension anywhere
- **L5** — Any SYSTEM_ADMIN can download any report
- **MR1** — Must a payment match the installment amount exactly?
- **MR2** — What happens to money above the amount due?
- **MR3** — Can a payment be posted against a later installment while an earlier one is unpaid?
- **MR4** — Where does the rounding difference land in a schedule?
- **MR5** — What is the penal charge on a missed EMI?
- **MR6** — What is the bounce charge when a NACH mandate fails?
- **MR7** — How is interest computed when a borrower settles early?
- **MR8** — Is there a pre-payment or foreclosure charge, and how much?
- **MR9** — Which day-count convention applies to a part-period accrual?
- **Q1** — Is this platform the accounting book of record?
- **Q2** — Is PRODUCT_ADMIN intended to change a live interest rate alone?
- **Q3** — Is OPS_USER intended to create applications for any LSP?
- **Q4** — ICICI account mandate — sole Bhawana signatory, or joint with the LSP?
